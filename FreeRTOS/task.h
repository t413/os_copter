...
void vTaskGetRunTimeStats( char *pcWriteBuffer, char resetCounters ) PRIVILEGED_FUNCTION;
unsigned int uxTaskGetIdlePercentage(char resetCounters) PRIVILEGED_FUNCTION;
